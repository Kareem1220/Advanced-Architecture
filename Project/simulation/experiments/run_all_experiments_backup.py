...
class ExperimentRunner:
    ...
    def generate_synthetic_dataset(self,
        ...
        # Find true top-100 for each query
        ground_truth = []
    ...
    def run_nm_rag(self, doc_embeddings, query_embeddings, k=100):
        ...
        logger.info(f"Quantization Quality - Recall: {recall * 100:.2f}%")

        return results

    def evaluate_retrieval_quality(self, all_results, ground_truth, k_values=[10, 100]):
    ...
    def run_all_experiments(self, num_docs=100000, num_queries=100):
        ...
        all_results['NM-RAG'] = self.run_nm_rag(doc_embeddings, query_embeddings)
